...
public class WorkLogbook {
  ...
  private String lastTimeTheDriverWorked;
  ...
  public WorkLogbook lastTimeTheDriverWorked(String lastTimeTheDriverWorked) {
  ...
  public String getLastTimeTheDriverWorked() {
    return lastTimeTheDriverWorked;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LAST_TIME_THE_DRIVER_WORKED)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLastTimeTheDriverWorked(String lastTimeTheDriverWorked) {
    this.lastTimeTheDriverWorked = lastTimeTheDriverWorked;
  }
