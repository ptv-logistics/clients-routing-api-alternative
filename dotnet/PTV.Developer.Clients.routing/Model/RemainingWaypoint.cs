...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class RemainingWaypoint : IValidatableObject
    {
        ...
        public RemainingWaypoint(string name = default(string), string estimatedTimeOfArrival = default(string), int? distance = default(int?), int? travelTime = default(int?), int? trafficDelay = default(int?), int? waitingTime = default(int?), List<ScheduleViolationType> scheduleViolations = default(List<ScheduleViolationType>), bool? violated = default(bool?))
        {
