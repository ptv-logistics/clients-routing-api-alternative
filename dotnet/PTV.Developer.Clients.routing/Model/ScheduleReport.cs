...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class ScheduleReport : IValidatableObject
    {
        ...
        public ScheduleReport(string startTime = default(string), string endTime = default(string), int? drivingTime = default(int?), int? serviceTime = default(int?), int? waitingTime = default(int?), int? breakTime = default(int?), int? restTime = default(int?))
        {
