...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class WorkLogbook : IValidatableObject
    {
        ...
        public WorkLogbook(string lastTimeTheDriverWorked = default(string), int? accumulatedDrivingTimeSinceLastBreak = 0, int? accumulatedWorkingTimeSinceLastBreak = default(int?), int? accumulatedDrivingTimeSinceLastDailyRest = default(int?), int? accumulatedTravelTimeSinceLastDailyRest = default(int?))
        {
        ...
        public string LastTimeTheDriverWorked { get; set; }
