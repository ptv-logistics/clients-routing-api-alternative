...
export interface Vehicle {
     ...
     * 
     * Relevant for `routing`.
     * Can only be used with **options[routingMode]=FAST**.
     * 
     * @type {string}
     * @memberof Vehicle
     */
